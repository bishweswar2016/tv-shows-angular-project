...
class MockDasboardService {
  getTvShows() {
    return Observable.create((observer: Observer<Array<ShowList>>) => {
...
describe('DashboardComponent', () => {
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      providers: [
        { provide: DashboardService, useClass: MockDasboardService }
      ],
      schemas: [
  ...
  it('should call ngOnInit and check data', async(() => {
      ...
      fixture.whenStable().then(() => {
        expect(component.showList).toEqual(mockData);
      });
    }));
